...
class AgilexAlohaEEposeMixRobotConfig(RobotConfig):
    ...
    motors: Dict[str, Motor] = field(
        default_factory=lambda norm_mode_body=norm_mode_body: {
            ...
            "pose_right_ori_rx": Motor(11, "piper-pose", norm_mode_body),
            "pose_right_ori_ry": Motor(12, "piper-pose", norm_mode_body),
            "pose_right_ori_rz": Motor(13, "piper-pose", norm_mode_body),
            ...
            "pose_left_pos_x": Motor(21, "piper-pose", norm_mode_body),
            "pose_left_pos_y": Motor(22, "piper-pose", norm_mode_body),
            "pose_left_pos_z": Motor(23, "piper-pose", norm_mode_body),
            "pose_left_ori_rx": Motor(24, "piper-pose", norm_mode_body),
            "pose_left_ori_ry": Motor(25, "piper-pose", norm_mode_body),
            "pose_left_ori_rz": Motor(26, "piper-pose", norm_mode_body),
        }
    )
