...
进入到 `robodriver-robot-agilex-aloha-follower-dora/` 目录。

```bash
cd robodriver/robots/robodriver-robot-agilex-aloha-follower-dora/
```
...
```bash
dora start robodriver/robots/robodriver-robot-agilex-aloha-follower-dora/dora/dataflow.yml --uv
```

如果是 Realsense 相机：

```bash
dora start robodriver/robots/robodriver-robot-agilex-aloha-follower-dora/dora/dataflow_realsense.yml --uv
```
