...
@RobotStatus.register_subclass("agilex_aloha_follower_dora")
@dataclass
class AgilexAlohaFollowerDoraRobotStatus(RobotStatus):
    device_name: str = "agilex_aloha_follower_dora"
