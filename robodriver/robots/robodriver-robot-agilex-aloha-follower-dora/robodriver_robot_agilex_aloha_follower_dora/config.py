...
@RobotConfig.register_subclass("agilex_aloha_follower_dora")
@dataclass
class AgilexAlohaFollowerDoraRobotConfig(RobotConfig):
    use_degrees = True
    norm_mode_body = (
    ...
    can_right_port: str = "can_f_right"
    can_left_port: str = "can_f_left"
