...
@TeleoperatorStatus.register_subclass("agilex_aloha_leader_dora")
@dataclass
class AgilexAlohaLeaderDoraTeleoperatorStatus(TeleoperatorStatus):
    device_name: str = "agilex_aloha_leader_dora"
