...
async def async_main(cfg: ControlPipelineConfig):
    ...
    sim = Simulator(backend=cfg.sim.backend, show_viewer=cfg.sim.show_viewer, xml_path=cfg.sim.xml_path) if cfg.sim is not None and cfg.sim.xml_path is not None else None
